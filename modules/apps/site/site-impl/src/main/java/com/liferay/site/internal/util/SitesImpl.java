...
public class SitesImpl implements Sites {
	...
	protected File exportLayoutSetPrototype(
		...
		try {
			file = _exportImportLayoutHelper.exportLayoutsAsFile(
				exportImportConfiguration);
		}
		catch (PortalException portalException) {
			_log.error(
	...
	protected void importLayoutSetPrototype(
		...
		_exportImportLayoutHelper.importLayoutSetPrototypeInBackground(
	...
	protected void mergeLayoutSetPrototypeLayoutsInBackground(
		...
		_exportImportLayoutHelper.mergeLayoutSetPrototypeInBackground(
